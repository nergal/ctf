        ...
        ig.Generaotr = ig.Class.extend({
            ...
            , getEntities: function(builder) {
                ...
                for (var i = 0, len = this._entities.length, entity; i < len; i++) {
                    ...
                    var newPos = builder.correction(entity['x'], entity['y'], this.getOptions('tilesize'))
                    entity.x = newPos.x
                    entity.y = newPos.y
                    
                    builder.map.setValueAt(entity.x / this.getOptions('tilesize'), entity.y / this.getOptions('tilesize'), 0)
